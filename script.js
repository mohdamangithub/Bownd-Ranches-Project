...
document.querySelector("#page4").addEventListener("mousemove", function (dets) {
  document.querySelector("#page4>img").style.left = dets.x -90 + "px"
  document.querySelector("#page4>img").style.top = dets.y -330 + "px"
  document.querySelector("#page4>button").style.left = (dets.x - 60) + "px"
  document.querySelector("#page4>button").style.top = (dets.y -100) + "px"
